...
convertUI(maya_path, 'fxToolsEdgeMotionTrail.ui')

convertUI(maya_path, 'prmanDenoiseToolsCmdR23.ui')
convertUI(maya_path, 'prmanR22_tools_rlfShaderEdit.ui')


convertUI(maya_path, 'shadingToolsCreateNodes.ui')
convertUI(maya_path, 'shadingToolsMeshLink.ui')
...
convertUI(maya_path, 'prmanR22_tools_vdbEdit.ui')
convertUI(maya_path, 'prmanR22_tools_objEdit.ui')
