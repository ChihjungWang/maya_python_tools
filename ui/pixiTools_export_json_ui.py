...
# Form implementation generated from reading ui file 'C:/Users/chihjung/Documents/maya/2018/scripts/ui/pixiTools_export_json.ui'
#
...
class Ui_main_widget(object):
    def setupUi(self, main_widget):
        ...
        self.objGrp_layout = QtWidgets.QHBoxLayout()
        self.objGrp_layout.setSpacing(4)
        self.objGrp_layout.setObjectName("objGrp_layout")
        ...
        self.objGrp_layout.addWidget(self.objGrp_LE)
        self.objGrpPick_PB = QtWidgets.QPushButton(main_widget)
        self.objGrpPick_PB.setMaximumSize(QtCore.QSize(100, 16777215))
        self.objGrpPick_PB.setObjectName("objGrpPick_PB")
        self.objGrp_layout.addWidget(self.objGrpPick_PB)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.objGrp_layout.addItem(spacerItem2)
        self.flag_commend_layout.setLayout(2, QtWidgets.QFormLayout.FieldRole, self.objGrp_layout)
        ...
        self.instanceGrp_layout = QtWidgets.QHBoxLayout()
        self.instanceGrp_layout.setSpacing(4)
        self.instanceGrp_layout.setObjectName("instanceGrp_layout")
        ...
        self.instanceGrp_layout.addWidget(self.instanceGrp_LE)
        self.instanceGrpPick_PB = QtWidgets.QPushButton(main_widget)
        self.instanceGrpPick_PB.setMaximumSize(QtCore.QSize(100, 16777215))
        self.instanceGrpPick_PB.setObjectName("instanceGrpPick_PB")
        self.instanceGrp_layout.addWidget(self.instanceGrpPick_PB)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.instanceGrp_layout.addItem(spacerItem3)
        self.flag_commend_layout.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.instanceGrp_layout)
        ...
        self.sourceCam_layout = QtWidgets.QHBoxLayout()
        self.sourceCam_layout.setSpacing(4)
        self.sourceCam_layout.setObjectName("sourceCam_layout")
        ...
        self.sourceCam_layout.addWidget(self.sourceCam_LE)
        self.sourceCamSetUp_PB = QtWidgets.QPushButton(main_widget)
        self.sourceCamSetUp_PB.setMaximumSize(QtCore.QSize(100, 16777215))
        self.sourceCamSetUp_PB.setObjectName("sourceCamSetUp_PB")
        self.sourceCam_layout.addWidget(self.sourceCamSetUp_PB)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.sourceCam_layout.addItem(spacerItem4)
        self.flag_commend_layout.setLayout(4, QtWidgets.QFormLayout.FieldRole, self.sourceCam_layout)
        ...
        self.canvasCam_layout.addItem(spacerItem5)
        self.flag_commend_layout.setLayout(5, QtWidgets.QFormLayout.FieldRole, self.canvasCam_layout)
        ...
        self.frameRange_layout.addItem(spacerItem6)
        ...
        self.sourceSize_layout.addItem(spacerItem7)
        ...
        self.canvasSize_layout.addItem(spacerItem8)
        ...
        self.textureMode_layout.addItem(spacerItem9)
        ...
        self.horizontalLayout_3.addWidget(self.exportJson_PB)
        self.convertSimpleJson_PB = QtWidgets.QPushButton(main_widget)
        self.convertSimpleJson_PB.setObjectName("convertSimpleJson_PB")
        self.horizontalLayout_3.addWidget(self.convertSimpleJson_PB)
    ...
    def retranslateUi(self, main_widget):
        ...
        self.objGrpPick_PB.setText(QtWidgets.QApplication.translate("main_widget", "Pick", None, -1))
        self.instanceGrp_label.setText(QtWidgets.QApplication.translate("main_widget", "Instance Group", None, -1))
        self.instanceGrpPick_PB.setText(QtWidgets.QApplication.translate("main_widget", "Pick", None, -1))
        self.sourceCam_label.setText(QtWidgets.QApplication.translate("main_widget", "Source Camera", None, -1))
        self.sourceCamSetUp_PB.setText(QtWidgets.QApplication.translate("main_widget", "Set Up", None, -1))
        ...
        self.sourceSizeW_LE.setText(QtWidgets.QApplication.translate("main_widget", "1024", None, -1))
        self.sourceSizeH_label.setText(QtWidgets.QApplication.translate("main_widget", "height", None, -1))
        self.sourceSizeH_LE.setText(QtWidgets.QApplication.translate("main_widget", "1024", None, -1))
        ...
        self.convertSimpleJson_PB.setText(QtWidgets.QApplication.translate("main_widget", "Convert To Simple Json", None, -1))
